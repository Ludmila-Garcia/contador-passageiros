...
while True:
    ...
    #valores anteriores 490, 230, 30, 150
    x,y,w,h = 200,600,460,30
    ...
    if brancos > 3900 and liberado == True:
        contador +=1
    if brancos < 3900:
        liberado = True
    else:
    ...
    cv2.rectangle(img, (575,155), (575 + 80, 155 + 85), (255, 255, 255), -1)
    cv2.putText(img, str(contador), (x+382, y-370), cv2.FONT_HERSHEY_SIMPLEX, 3, (575, 0, 0), 5)
